...
object PublishSettings {
	def publishSettings = Seq(
	    ...
	    pomExtra := (
	      ...
	      <scm>
	        <url>git://github.com/aghosn/scala-sublime.git</url>
	        <connection>scm:git:git://github.com/aghosn/scala-sublime.git</connection>
	      </scm>
	      <issueManagement>
	        <system>GitHub</system>
	        <url>https://github.com/aghosn/scala-sublime/issues</url>
	      </issueManagement>
	    ),
